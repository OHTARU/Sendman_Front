                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SingleChildScrollView(
                      ...
                      child: (textNum == 0)? Text("최근 대화가 없습니다!",style: TextStyle(fontWeight: FontWeight.w500, fontSize:  20)) :Row(
                            ...
                            child: InkWell(
                              onTap: () {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) => TtsDetail(recognizedText: result![index].text))
                                    );
                              },
                              child: Container(
                                width: 140,
...
Widget build(BuildContext context) {
  return PopScope(
    ...
    child: Scaffold(
      appBar: (sessionGoogle.username != "anonymous")? BaseAppBar(
        appBar: AppBar(),
        center: true,
      ): null,
      body: ConstrainedBox(
      ...
      drawer: (sessionGoogle.username != "anonymous")? const BaseDrawer(): null,
